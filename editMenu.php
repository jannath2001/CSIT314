...
$foodBeverage = $MenuController->getAllFood($conn);
?>
...
<div class="header">
    ...
    <div class="table-container">
        ...
        <!-- Add menu Button-->
        <div class="add-food&beverage-container">
            <a href="addMenu.php" class="add-food&beverage-button">Add Food or Beverages</a>
        </div>
    </div>
</body>
